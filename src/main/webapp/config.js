window.APP_CONFIG = {
    ...
    githubLink: "https://github.com/MonYamau/cloud-file-storage",
    ...
    * */
    ...
    functions: {
        ...
        //Функция для маппинга формата данных бэка в формат фронта.
        ...
        //В данном маппинге подразумевается, что obj.path c бэка будет приходить со слэшом на конце.
